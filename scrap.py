...
class Scraper_Master():
    ...
    def start(self):
        fist_scrap = self.scraper("https://www.transfermarkt.com.br/campeonato-brasileiro-serie-a/marktwerte/wettbewerb/BRA1/pos//detailpos/0/altersklasse/alle/plus/1")
        scrap = bs(fist_scrap,'html.parser')
        print("Fazendo Scrap da pagina 01")
